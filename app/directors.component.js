...
var DirectorsComponent = (function () {
    function DirectorsComponent(_directorSerice) {
        this._directorSerice = _directorSerice;
        this.directors = this._directorSerice.getDirectors();
    }
